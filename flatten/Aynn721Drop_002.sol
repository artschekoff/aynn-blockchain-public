$ /Users/riskyworks/Documents/web/all-you-need-is-nft/app/AYNN.Blockchain/node_modules/.bin/hardhat flatten src/contracts/token/ERC721/Aynn721Drop_002.sol
...
// File src/contracts/token/ERC721/Aynn721Drop_002.sol
...
contract Aynn721Drop_002 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(
    ...
    setBaseURI(string(abi.encodePacked('ipfs://', _folderHash, '/')));
    maxSupply = _maxSupply;
    _preMinted = __preMinted;
    _scopeCap = _maxSupply - __preMinted;
  }
  ...
  function getPreMinted() public view returns (uint256) {
    return _preMinted;
  }
