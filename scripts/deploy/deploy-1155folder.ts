...
async function deploy() {
  ...
  var args = ["#HASH", '0x0000000000000000000000000000000000000000', 0]
  const folder = await attacher.attachOrDeploy("Aynn1155Folder_001", ...args)
  console.log({ folder });

  console.log("Verification command:")
  console.log("npx hardhat verify --network fantom " + folder.address + " --contract src/contracts/token/ERC1155/Aynn1155Folder_001.sol:Aynn1155Folder_001 " + args.join(" "))
// npx hardhat verify --network sepolia 0x4172d582a76BCd8B89109fE7470c1592CB3438F8 --contract src/contracts/token/ERC1155/Aynn1155Folder_001.sol:Aynn1155Folder_001 '#HASH' '0x0000000000000000000000000000000000000000' 0
